...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <header class="mb-8 text-center">
        ...
        <p class="text-gray-600">Crie, leia, atualize e exclua usuários com Laravel, Vite e Tailwind</p>
    </header>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden card-hover">
        <div class="flex flex-row sm:flex-row justify-between items-center p-6 border-b border-gray-200">
            ...
            <a href="{{ route('users.create') }}" class="flex items-center justify-center bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition duration-200 shadow-md">
        ...
        <div class="p-6">
            @if ($users->count() > 0)
                <ul class="divide-y divide-gray-200">
                    ...
                    <li class="py-5 px-4 hover:bg-gray-50 rounded-lg transition duration-150">
                        <div class="flex flex-row sm:flex-row sm:items-center justify-between">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('users.show',['user' => $user->id]) }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200 flex items-center shadow-sm">
                                    <i class="fas fa-eye mr-1"></i> Visualizar
                                </a>
                                <a href="{{ route('users.edit',['user' => $user->id]) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200 flex items-center shadow-sm">
