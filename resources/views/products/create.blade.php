...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-6 text-center">
        <h1 class="text-3xl font-bold text-gray-800">Cadastrar Produto</h1>
        <p class="text-gray-600 mt-2">Preencha os dados abaixo para criar um novo produto.</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <form class="flex flex-col gap-4" action="{{ route('products.store') }}" method="POST">
            @csrf
